...
import com.micSer.envArch.service.*;
...
import com.micSer.envArch.config.AuditClient;
...
public class FileController {
    ...
    private final GetFilesService getFilesService;
    private final RenameFileService renameFileService;
    private final ReplaceFileService replaceFileService;
    ...
    public ResponseEntity<FileMetadata> uploadFile(
        ...
        FileMetadata metadata = uploadFileService.execute(
    ...
    public ResponseEntity<List<FileMetadata>> listFiles() {
        User user = getCurrentUser();
        List<FileMetadata> files = getFilesService.execute(user.getId());
    ...
    public ResponseEntity<FileMetadata> renameFile(
        ...
        FileMetadata updated = renameFileService.execute(id, user.getId(), newName);
    ...
    public ResponseEntity<FileMetadata> replaceFile(
        ...
        User user = getCurrentUser();
        FileMetadata updated = replaceFileService.execute(
                id,
                user.getId(),
                file.getOriginalFilename(),
                file.getSize(),
    ...
    public ResponseEntity<Map<String, String>> deleteFile(
        ...
        User user = getCurrentUser();
        deleteFileService.execute(id, user.getId());
    ...
    public ResponseEntity<?> viewFile(
        ...
        User user = getCurrentUser();
        InputStream inputStream = downloadFileService.execute(id, user.getId());
        FileMetadata metadata = downloadFileService.getMetadata(id, user.getId());
